			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div id="home" class="brand">
						<div class="home_box">
							<h1 class="counter_title" style="margin-top:-1.5%;">
								SIN 2017<br>
								<span style="font-size: 25px;">(October 13-15, 2017)</span>
							</h1>
	...
	<div class="main main-raised">
							...
							<div class="loaction-event">
								<table>
									<tr>
										...
										<td style="width: 100%;">
											<p class="event_info"><span>Announcements</span></p>
												<div id="news" class="ticker">
													<ul>
														<li>Submission Deadline: June 15, 2017</li>
														<li>Authors Notification: July 16, 2017</li>
														<li>Final Manuscript Due: August 12, 2017</li>
														<li>Paper Registration Deadline: August 12, 2017</li>
													</ul>
												</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 col-sm-12 col-xs-12 text-center border-hide" style="border-left: 1px dotted #363f4a;">
						...
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4" style="box-shadow: 0px 1px 10px rgba(0, 0, 0, 0.4);width: 100px;">
								<h2 class="title" style="margin: 0;">15</h2>
								<h4 style="margin: 0;">June' 17</h4>
							</div>
						...
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4" style="box-shadow: 0px 1px 10px rgba(0, 0, 0, 0.4);width: 100px;">
								<h2 class="title" style="margin: 0;">16</h2>
								<h4 style="margin: 0;">July' 17</h4>
							</div>
							<div class="col-md-8 col-sm-8 col-xs-8 text-left" style="margin-top: 2%;">
						...
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4" style="box-shadow: 0px 1px 10px rgba(0, 0, 0, 0.4);width: 100px;">
								<h2 class="title" style="margin: 0;">12</h2>
								<h4 style="margin: 0;">Aug' 17</h4>
							</div>
							<div class="col-md-8 col-sm-8 col-xs-8 text-left" style="margin-top: 2%;">
								<h4 class="title" style="color: #ffa20f;">Final Manuscript Due</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-4" style="box-shadow: 0px 1px 10px rgba(0, 0, 0, 0.4);width: 100px;">
							...
							<div class="col-md-8 col-sm-8 col-xs-8 text-left" style="margin-top: 2%;">
								<h4 class="title" style="color: #ffa20f;">Paper Registration Deadline</h4>
							</div>
						</div>
					</div>													
				</div>
				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12 col-xs-12">
							<img src="assets/img/org/muj-logo.png" alt="Manipal University Jaipur" class="img-responsive sponsors-item">		<h5>Manipal University Jaipur, Rajasthan, India</h5>							
						</div>
						<div class="col-md-4 col-sm-12 col-xs-12">
		...
		<section class=" section contact_wrapper">
			<div class="container"> 
				...
				<div class="row">
					<div class="col-md-12">
						<div class="contact_box"> <i class="fa fa-map-marker fa-4x blue"></i><br>						
							<h4 class="contact_details"><strong>Manipal University Jaipur</strong>, Dehmi Kalan, Near GVK Toll Plaza,</h4>
							<h4 class="contact_details"> Jaipur-Ajmer Expressway, Jaipur, Rajasthan 303007</h4>
						</div>
					</div>
					<div class="col-md-12 text-center">
						<a href="https://jaipur.manipal.edu/muj.html">
							<button class="btn btn-raised btn-primary">Visit MUJ Website
