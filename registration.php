...
<div class="wrapper">
	...
	<div class="main main-raised">								
		<section class="section">
			<div class="container">
				<div class="row">										
					<h2 class="title text-center">Conference Registration Fee</h2>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<h4 style="text-align: center;">Please go through the link for registraion, <a href="https://goo.gl/forms/YY8usGfAtm8gBBLx2" target="_blank"><strong>https://goo.gl/forms/YY8usGfAtm8gBBLx2</strong></a></h4>
					</div>
				</div><br>
				<div class="row">
